/*
 ----------------------------------------------------------------------------
 | GraphQLServer: EWD.js GraphQL Application Server Interface               |
 |                                                                          |
...
module.exports = {
  ...
  onMessage: {
    GraphQL: function GraphQL(params, ewd) {
      if (!params.query || params.query === '') return { errors: [{ message: 'Undefined or Empty query' }] };
